...
2022年度報告書で提案したDataOpsプロセスのオープンデータ利活用への有効性を証明する為、検証イベントを開催した。  

イベントの中で行われたディスカッションやアンケートの結果から、以下の課題を洗い出した。  
...
2022年度報告書で提案したDataOpsプロセスに対して以下のような課題があった。  

1. データ提供者は扱いにくいデータを公開する  
2. データが扱いにくい為、データ利用者が少ない  
3. データ利用者が少ない為、フィードバックが少ない  
4. フィードバックが少ない為、ニーズのあるデータが公開できない  

前述の改善方法により、DataOpsプロセスは以下のような善循環のサイクルに改善することが可能となり、DataOpsプロセスのデータ利活用促進への有効性が証明できると考えられる。  
