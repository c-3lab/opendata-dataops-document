...
### **本報告書の位置づけ**
本報告書は、2022年度版の「[DataOpsを活用したオープンデータ利活用に関する報告書](opendata_dataops.md)」（以下、2022年度報告書）で提案したDataOpsプロセスのオープンデータ利活用への有効性を証明する為、各プロセスにおける作業を実践する開発イベントを開催することでその有効性を証明するものである。
...
この提案の有効性については未検証であり、その根拠を定義する為に実践証明を実施する必要がある。

### **オープンデータDataOps検証イベント**
本報告書の作成に先立ち、以下のイベントを開催した。
